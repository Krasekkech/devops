...
### Результат
Для выполнения задания были выбраны nginx и postgresql

Вывод после обработки сборки докерфайла
![Screen](https://github.com/Krasekkech/devops/blob/HW/screenshots/hw4/Снимок%20экрана%202025-06-21%20212420.png)
